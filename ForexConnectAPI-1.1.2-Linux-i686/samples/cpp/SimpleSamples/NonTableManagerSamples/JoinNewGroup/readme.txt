...
url - the URL of the server. 
  The URL must be a full URL, including the path to the host descriptor. Optional argument. 
  For example, http://www.fxcorporate.com/Hosts.jsp
connection - connection name. Optional argument. For example, "Demo" or "Real".
[subsession] - database name. Optional argument. 
