...
3. Modify subscription for the selected instrument.
4. Show margin requirements for newly subscribed instrument.
5. Update margin requirements.
6. Show margin requirenets for the same instrument again.
7. Logout.
...
Arguments
==============================================================================================
instrument - instrument, which subscription you want to modify. Mandatory argument.
For example, CAD/JPY. If you are already subscribed to this instrument, no action will be taken.
status - new subscription status:
		'D' - Disabled
		'T' - Available for trade
		'V' - View only
