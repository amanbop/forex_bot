LockUpdates application (with TableManager)
==========================================================================================
This application will perform the following actions:
1. Login.
2. Check margin requirements.
3. Open position for the specified instrument.
4. Lock updates and print Orders table
5. Unlock updates and listen Orders table changes
6. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\OpenPosition>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\OpenPosition>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{INSRUMENT} - instrument, for which you want to open a position. Mandatory argument.
For example, EUR/USD. 
