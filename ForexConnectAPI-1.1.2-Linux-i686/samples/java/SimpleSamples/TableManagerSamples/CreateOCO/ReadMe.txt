Create OCO (with TableManager)
==========================================================================================
This application will perform the following actions:
1. Login.
2. Create pair of OCO orders for the specified instrument.
3. Add an entry order to an existing OCO group.
4. Remove an order from the OCO group.
5. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\CreateOCO>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\CreateOCO>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{INSTRUMENT} - instrument, for which you want to create OCO orders. Mandatory argument.
For example, EUR/USD. 
