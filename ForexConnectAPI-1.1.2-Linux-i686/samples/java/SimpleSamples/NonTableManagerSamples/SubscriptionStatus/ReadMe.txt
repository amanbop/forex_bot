Subscription Status application
==========================================================================================
This application will perform the following actions:
1. Login.
2. Show current subscription list. 
3. Subscribe to the specified instrument.
4. Unsubscribe from the specified instrument.
5. Show refreshed subscription list. 
6. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\subscriptionstatus>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\subscriptionstatus>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{SUBSCRIBE} - instrument, to which you want to subscribe. Mandatory argument.
For example, CAD/JPY. If you are already subscribed to this instrument, no action will be taken.
{UNSUBSCRIBE} - instrument, from which you want to unsubscribe. Mandatory argument.
For example, GBP/AUD. If you are already unsubscribed from this instrument, no action will be taken.
