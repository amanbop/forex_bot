...
1. Login.
2. Return bid and ask prices for all offers. 
3. Optional. If trading instrument is specified in the argument list it will do the following:
   a) send request and receive response for a specified instrument.
   b) receive live offer updates for a specified instrument.
4. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\getoffers>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\getoffers>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{INSTRUMENT} - instrument, for which you want to get live offer updates. Optional argument.
For example, EUR/USD. If you don't want to receive live offer updates and only interested in
prices for all instruments at the time of login, leave this argument as it is.
