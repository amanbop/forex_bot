Update Margin Requirements application
==========================================================================================
This application will perform the following actions:
1. Ask user to unsubscribe from the specified instrument.
2. Login.
3. Subscribe to the specified instrument.
4. Show margin requirements for the instrument.
5. Update margin requirements.
6. Show margin requirements for the same instrument again. 
7. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\updatemarginrequirements>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\updatemarginrequirements>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{INSTRUMENT} - instrument to which you want to unsubscribe before login and subscribe later. Mandatory argument.
For example, AUD/USD. 
