Join Existing Group application
==========================================================================================
This application will perform the following actions:
1. Login.
2. Join an entry order to an existing OCO group.
3. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\joinexistinggroup>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\joinexistinggroup>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{CONTINGENCY} - contingency ID of group, to which you want to join an entry order.
Mandatory argument. For example, 85433014.
{ORDER} - order, which you want to join to existing contingency group. Mandatory argument.
