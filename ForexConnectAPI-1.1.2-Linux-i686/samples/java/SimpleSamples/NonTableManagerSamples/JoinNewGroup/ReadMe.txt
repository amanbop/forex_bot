Join New Group application
==========================================================================================
This application will perform the following actions:
1. Login.
2. Join two entry orders into new OCO group.
3. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\joinnewgroup>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\joinnewgroup>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{ORDER1} - first order, which you want to add to a new contingency group. Mandatory argument.
For example, 85327939.
{ORDER2} - second order, which you want to add to a new contingency group. Mandatory argument.
For example, 85327940.
{ACCOUNT} - account for which first and second orders were placed. Mandatory argument.
