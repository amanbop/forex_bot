...
1. Login.
2. Request historical prices for specified timeframe for last trading day. 
3. If request is not filled completely will issue additional request(s) until complete fill.
4. Logout.
...
Arguments
==============================================================================================
instrument - instrument, for which you want to get historical prices. Mandatory argument.
For example, EUR/USD.
timeframe - time period which forms a single candle. Mandatory argument.
			timeframe: t1, m1, m5, m15, m30, H1, H2, H4, H6, H8, H12, D1, W1, M1
