...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\getreporturl>ant rebuild
This will generate directory structure .\build\classes\getreporturl and place compiled files there.
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\getreporturl>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{USERNAME} - your user name. Mandatory argument.
{PASSWORD} - your password. Manadatory argument.
