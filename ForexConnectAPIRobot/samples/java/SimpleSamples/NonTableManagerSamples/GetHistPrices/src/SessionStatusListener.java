...
public class SessionStatusListener implements IO2GSessionStatus {
    ...
    private SimpleLog mSimpleLog = null;
    ...
    // Constructor
    public SessionStatusListener(O2GSession session, SimpleLog simpleLog, String dbName, String pin) {
        mSession = session;
    ...
    public final void onSessionStatusChanged(O2GSessionStatusCode status) {
        mStatus = status;
        mSimpleLog.log("Status: {0} ", mStatus.toString());
