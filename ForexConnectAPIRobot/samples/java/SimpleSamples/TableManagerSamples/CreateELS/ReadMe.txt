Create ELS (with TableManager)
==========================================================================================
This application will perform the following actions:
1. Login.
2. Create entry order with attached stop and limit orders for the specified instrument.
3. Change rate of secondary limit order.
4. Remove secondary limit order.
5. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\CreateELS>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\CreateELS>ant run
This will run the application and display the output on your console.

Arguments
==============================================================================================
{INSTRUMENT} - instrument, for which you want to create an entry order 
with attached stop and limit orders. Mandatory argument.
For example, EUR/USD. 
