Print Table application (using TableManager)
==========================================================================================
This application will perform the following actions:
1. Login.
2. Print Offers table.
3. Refresh Trades table.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\PrintTable>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\PrintTable>ant run
