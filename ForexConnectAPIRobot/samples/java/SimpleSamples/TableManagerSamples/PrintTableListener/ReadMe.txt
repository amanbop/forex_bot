PrintTableListener application (using TableManager)
==========================================================================================
This application will perform the following actions:
1. Login.
2. Listen a table manager notification about tables loading
3. Print Offers table.
4. Print Trades table.
5. Logout.
...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\PrintTableListener>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\SimpleSamples\TableManagerSamples\PrintTableListener>ant run
