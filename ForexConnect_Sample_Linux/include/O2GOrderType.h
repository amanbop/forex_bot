...
namespace Commands
{
    ...
    static const char JoinToOCO[] = "JoinToOCO";
    static const char ExcludeFromOCO[] = "ExcludeFromOCO";
...
namespace SystemProperties
{
    ...
    static const char QUERYDEPTH_1[] = "QUERYDEPTH_0";
    static const char QUERYDEPTH_2[] = "QUERYDEPTH_0";
    static const char QUERYDEPTH_3[]= "QUERYDEPTH_0";
    static const char QUERYDEPTH_4[] = "QUERYDEPTH_0";
    static const char QUERYDEPTH_5[] = "QUERYDEPTH_0";
    static const char QUERYDEPTH_6[] = "QUERYDEPTH_0";
    static const char QUERYDEPTH_7[] = "QUERYDEPTH_0";
    static const char QUERYDEPTH_8[] = "QUERYDEPTH_0";
